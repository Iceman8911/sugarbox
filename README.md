...
Loosely based off *Twine Sugarcube*, **Sugarbox** is a lightweight (~8KB), headless, unopionionated, and framework-agnostic library to help with developing web-based interactive fiction.
